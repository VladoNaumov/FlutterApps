...
/*
тот код создаёт Flutter-приложение с интерфейсом, содержащим три вкладки. Каждая вкладка имеет иконку в верхней панели (TabBar) и отображает соответствующее содержимое в TabBarView. Вкладки управляются с помощью DefaultTabController, который синхронизирует выбор вкладки с отображаемым содержимым.
