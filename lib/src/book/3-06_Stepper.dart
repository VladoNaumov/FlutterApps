...
/*
Этот код создаёт Flutter-приложение с экраном, на котором отображается виджет Stepper (пошаговый интерфейс).
Stepper состоит из трёх шагов ("Get Ready", "Get Set", "Go!"), которые отображаются вертикально.
Пользователь может переключаться между шагами с помощью кнопок "Continue" и "Cancel". Т
екущее состояние шага хранится в переменной _currentStep и обновляется с помощью setState.
