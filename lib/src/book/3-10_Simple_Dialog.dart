...
/*
* Этот код создаёт простое приложение на Flutter, которое показывает экран с кнопкой.
* При нажатии на кнопку открывается диалоговое окно, где пользователь может выбрать любимую еду ("Brocolli" или "Steak").
* После выбора результат выводится в консоль. Давайте разберём, как это работает:
