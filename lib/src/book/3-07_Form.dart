...
Этот код создаёт Flutter-приложение с экраном, содержащим простую форму для ввода имени пользователя (e-mail) и пароля.
Форма включает валидацию и кнопку для отправки данных.
После успешной валидации данные сохраняются в объект LoginData и выводятся в консоль.
