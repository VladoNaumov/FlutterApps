...
/*
Этот код создаёт Flutter-приложение с нижней панелью навигации (BottomNavigationBar),
содержащей три вкладки: "Announcements", "Messages" и "Profile".
Каждая вкладка отображает соответствующую страницу с текстом в центре экрана.
Переключение между страницами осуществляется через изменение индекса _selectedIndex с помощью setState.
