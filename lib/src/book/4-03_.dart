...
DataTable:Виджет для создания таблицы с сортируемыми столбцами и строками.
...
DataRow:Представляет строку таблицы.

cells: список DataCell для ячеек строки.

DataCell:Представляет ячейку таблицы.
...
Text:Отображает текст в заголовках столбцов или ячейках.
