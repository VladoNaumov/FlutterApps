...
Text:Отображает текст ("Click it!") в центре экрана.

FloatingActionButton:Плавающая кнопка действия, обычно используется для основного действия на экране.
...
Icon:Отображает иконку из библиотеки Material Design (здесь Icons.add — значок "плюс").
